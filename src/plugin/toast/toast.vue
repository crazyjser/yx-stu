<template>
	<div id="toast">
		<div class="c-message messageFadeInDown" v-show="is_show" ref="toast">
	      <i class=" c-message--icon" :class="iconType"></i>
	      <a class="c-message--close" @click="remove()">×</a>
	      <div class="c-message--tip">{{message}}</div>
	    </div>
	</div>
</template>
<script>
	export default {
		...
		computed:{
			iconType(){
				switch(this.type){
					case 'success':
						return 'c-message--success'
						break;
					case 'error':
						return 'c-message--error'
						break;
					case 'info':
						return 'c-message--info'
						break;
					case 'warning':
						return 'c-message--warning';
						break;			
				}
			}
		},
		methods:{
			show(options){
				this.is_show = true;
				this.$refs.toast.className = 'c-message messageFadeInDown';
				if(typeof options === 'string'){
		      	...
		      	if(this.autoClose){
		      		this.timer = setTimeout(()=>{
		      			this.$refs.toast.className = 'c-message messageFadeInDown messageFadeOutUp';
